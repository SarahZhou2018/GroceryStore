...
<body onload="updateSubtotal(7.99)">
    <header>
        <div class="product-name-header">
            Product Description - Ice Cream, 473 mL
        </div>
    </header>
    <nav>
        <ul>
            ...
            <li><a href="../aisles/frozen.php">Return to Aisle</a></li>
    ...
    <div class="main-body">
        ...
        <div class="description">
            <div class="image">
                ...
                <img src="../images/bj.jpg" alt="Ice Cream" width="150px" height="200px" />

            </div>
            <h2>Chocolate ice cream, 473 mL</h2>
            <p>7.99$/each</p>
            <p>Weight: 1 lb</p>
            <h3>Product Description</h3>
            <p>When smooth chocolate ice cream meets fudge chips & salty swirls, they pack a serious one-two crunch.</p>
            ...
            <form action="../shopping-cart/index.html">
                ...
                <input type="number" id="quantity" name="quantity" min="1" value=1 size="2" onchange="updateSubtotal(7.99)">
                <label for="type">Type:</label>
                <select id="type" name="type">
                    <option value="80-20">Chocolate</option>
                    <option value="93-7">Chocolate & Vanilla</option>
                </select>
