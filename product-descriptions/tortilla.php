...
<body onload="updateSubtotal(3.29)">
    <header>
        <div class="product-name-header">
            Product Description - Tortilla
        </div>
    </header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="../aisles/bread.php">Return to Aisle</a></li>
    ...
    <div class="description">
        <div class="image">
            <img src="../images/tortilla.jpg" alt="Tortilla" width="200px" height="200px" />
        </div>
        <h2>Tortilla</h2>
        <p>3.29$/each</p>
        <p>Weight: 300 g</p>
        ...
        <form action="../shopping-cart/index.html">
            ...
            <input type="number" id="quantity" name="quantity" min="1" value=1 size="2" onchange="updateSubtotal(3.29)">
            <label for="type">Type:</label>
            <select id="type" name="type">
                <option>Large (6 tortillas)</option>
                <option>Small (10 tortillas)</option>
            </select>
