<!--
    ...
    <body onload="updateSubtotal(4.99)">
        <header>
            <div class="product-name-header">
                Product Description - FireCracker Popsicle
            </div>
        </header>
        ...
        <div class="description">
            <div class="image">
                <img src="../images/popp.jpg" alt="pop" width="200px" height="200px" />
            </div>
            <h2>FireCracker Popsicle</h2>
            <p>4.99$/each</p>
            <p>18 pack</p>
            <h3>Product Description</h3>
            <p>blue, white and red popsicles</p>
            ...
            <form action="../shopping-cart/index.html">
                ...
                <input type="number" id="quantity" name="quantity" min="1" value=1 size="2" onchange="updateSubtotal(4.99)">
